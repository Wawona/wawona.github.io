...
![Wawona Preview](static/images/wawona-screenshots/SplitPreviewWawonaio.jpg)
...
3. Provide a network-accessible URL for other devices on the LAN.

Donate is GitHub Sponsors (amount and monthly vs one-time in the URL). Ko-fi is the alternative. No Checkout API or payment keys.

**Enter the development environment:**
```bash
nix develop
```
This drops you into a shell with Zola.
